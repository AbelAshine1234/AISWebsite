                ...
                <div className="row">
                    ...
                    <div className="col-xl-5 col-lg-6 col-12" data-aos="fade-up" data-aos-delay="300">
                        <div className="about-content-area">
                            ...
                            <p>Our goal is to make the process easier for you. We provide our clients with the right tools for web and mobile app development, ERP Solutions,security, content and marketing.</p>
