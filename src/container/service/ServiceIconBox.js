    ...
    return (
        <div className={`section section-padding-t90-b100 ${classOption}`}>
            <div className="container">
                ...
                <SectionTitle
                    title="We Transform Visions into Seamless Solutions"
                    subTitle="Our mission is to bring your visionary ideas to life by creating innovative solutions that empower your success."
                />
