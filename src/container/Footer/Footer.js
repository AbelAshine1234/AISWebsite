    ...
    return (
        <div className="footer-section section footer-bg-color">
            <div className="container">
                ...
                <div className="row">
                    <div className="col">
                        <p className="copyright">&copy; {new Date().getFullYear()} <strong>Andinet</strong> Made with <i className="fas fa-heart text-danger"></i> by <a href="#"><strong>Andinet Digital Solution</strong></a>.</p>
                    </div>
                </div>
