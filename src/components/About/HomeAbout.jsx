    ...
    return (
        <div className="section section-padding-t90 section-padding-bottom-200">
            <div className="container">
                ...
                <SectionTitle
                    title="We are a full-service software company"
                    subTitle="Our team of  developers, designers and creatives are perfectionists
                    ...
                    <div className="col-xl-5 col-lg-6 col-12" data-aos="fade-up" data-aos-delay="300">
                        <div className="about-content-area">
                            <SectionTitleTwo 
                                ...
                                title="software company focused on vision, product and people"
                            />

                            <p>Andnet ICT Solution is A company based in Ethiopia, it provides IT consulting and custom software development.</p>
